...
pub trait DrawModel<'a> {
    ...
    fn draw_mesh_instanced(&mut self, mesh: &'a Mesh, instances: Range<u32>, material: &'a Material, camera_bind_group: &'a wgpu::BindGroup);
    ...
    'b: 'a
{
    ...
    fn draw_mesh_instanced(&mut self, mesh: &'b Mesh, instances: Range<u32>, material: &'a Material, camera_bind_group: &'a wgpu::BindGroup) {
